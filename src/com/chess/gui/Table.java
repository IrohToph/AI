...
public final class Table extends Observable {
    ...
    private Color darkTileColor = Color.decode("#b58862");
    ...
    private JMenu createPreferencesMenu() {
        ...
        final JMenuItem normalMenuItem = new JMenuItem("Normal");
        chessMenChoiceSubMenu.add(normalMenuItem);
